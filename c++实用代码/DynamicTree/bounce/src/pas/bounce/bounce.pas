...
var
  a:array[0..210000]of splaya;
  father:array[0..210000]of longint;
...
procedure rightrotate(x:longint);inline;   //右旋
var
	y,z:longint;
begin
	y:=a[x].p;
...
procedure leftrotate(x:longint);inline;   //左旋
var
	y,z:longint;
begin
	y:=a[x].p;
...
procedure splay(x:longint);inline;   //核心操作:单旋splay
  begin
  if x=0 then exit;
  while a[x].p<>0 do

var
  ...
  next,v,c,start,son,maxcost,deep,ll,rr:array[0..20010]of longint;
  root,costfa,fa,tmp,e:array[0..20010]of integer;
  p:array[0..20010]of boolean;
  ro:integer;
  ch:char;

...
void work()
{
    for (int k = n; k; k--)
    {
        ...
        for (int j = 0; j <l; j++)tmp[j]=abs(c[j].v^523543654765LL)%Pmax;
        ...
        for (int j = 0; j < H.p; j++)
        	{
				...
				v[i]=(v[i]*Q+1645765468895LL)^235346457675LL;
			}
		v[i] = (v[i] * Q) ^765432645476571LL;
		//printf("v[%d]=%d\n",i,v[i]);
    }
}
int main()

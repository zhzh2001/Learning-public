...
const int ra = 4000005;	//线段树常量
int c[ ra * 2 ], d[ ra * 2 ];	 //线段树
int a[ 1000005 ], b[ 1000005 ];   //排序临时变量
int order[ 4000005 ], torder[ 1000005 ]; //排序结果
int index[ 1000005 ];	 //排序结果取反（为了在常数时间内取得某数的位置）
int road[ 1000005 ][ 8 ];	//每个点连接出去的8条边
int y[ 1000005 ], x[ 1000005 ];	 //点坐标
int n;		 //点个数
...
int ta[ 65536 ], tb[ 1000005 ];	//基数排序临时变量
...
int ttb[ 4000005 ];	  //边排序的临时变量

int rx[ 4000005 ], ry[ 4000005 ], rd[ 4000005 ]; //边的存储
int rr = 0;
...
int father[ 1000005 ], rank[ 1000005 ];	//并查集
